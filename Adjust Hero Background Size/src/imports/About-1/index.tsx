function Group2() {
  return (
    <div className="[word-break:break-word] absolute contents leading-[0] left-[834px] text-black top-[484px]">
      <div className="absolute font-['Geist:Light',sans-serif] font-light h-[232px] left-[834px] text-[18px] top-[538px] w-[644px] whitespace-pre-wrap">
        <p className="mb-0">
          ...
          <span className="[word-break:break-word] font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] text-[#9173b3]">security</span>
        ...
        <p>
          ...
          <span className="[word-break:break-word] font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] text-[#9173b3]">product design</span>
          <span className="leading-[normal]">{` and `}</span>
          <span className="[word-break:break-word] font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] text-[#9173b3]">UI/UX</span>
      ...
      <div className="absolute font-['Instrument_Sans:Medium',sans-serif] font-medium h-[40px] left-[834px] text-[33px] top-[484px] w-[711px]" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Group() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(50%+35.5px)] top-[calc(50%-1082px)]">
      <p className="[word-break:break-word] absolute font-['Instrument_Sans:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%-88.5px)] text-[70px] text-black top-[calc(50%-1124.5px)] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        ABOUT
      </p>
    </div>
  );
